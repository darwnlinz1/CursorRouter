...
Whenever you push a version tag starting with  (e.g., 2.5.0), GitHub Actions will automatically:
...
2. **Publish on GitHub:**
   ...
   - Choose a tag (e.g. 2.5.0) and title (e.g. CursorRouter v2.5.0 - Hardware Isolation & Desktop Cockpit).
