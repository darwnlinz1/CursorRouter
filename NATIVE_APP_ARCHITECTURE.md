...
| **Host Keyboard Safety** | Fake Alt keydown hacks without release | **Win32 Activation + Guaranteed Modifier Unstick in inally:** | Prevents host keyboard freeze; auto-releases Alt (0x12), Ctrl (0x11), Shift (0x10), Win keys. |
